...
| :--------------- | :-------------------------------------------------------------------------------------------------------------- | :---------------------------------------------------------------------------------------------------------- |
| **CoFounderX**   | 🥈 HEC Hackathon 2nd Place Winner - Multi-agent AI system that transforms ideas into launch-ready startups     | `LangChain` `CrewAI` `Next.js` `Python` `OpenAI` `Groq`                                                    |
| **CyberGuard**   | Intelligent cybersecurity threat detection and prevention system with ML-powered anomaly detection              | `Python` `Machine Learning` `FastAPI` `React.js` `Real-time Analytics`                                     |
| **AI Pitch Writer**   | Grand-scale project - AI-powered platform for generating professional startup pitches and business proposals   | `Next.js` `NestJS` `PostgreSQL` `Prisma` `TypeScript` `Tailwind CSS`                                       |

<br>

## 📚 Other Projects

> Check out more of my work on my GitHub repositories. I'm constantly building and experimenting with new technologies!
...
<div align="center">
  <a href="https://linkedin.com/in/nareen-asad"><img src="https://img.shields.io/badge/LinkedIn-0A0209?style=for-the-badge&logo=linkedin&logoColor=d5d5d5" alt="LinkedIn profile" /></a>
  <a href="mailto:nareenasad07@gmail.com"><img src="https://img.shields.io/badge/Gmail-0A0209?style=for-the-badge&logo=gmail&logoColor=d5d5d5" alt="Email" /></a>
</div>
...
<p align="center">
  ...
  <img src="https://github-readme-stats-sigma-five.vercel.app/api/top-langs/?username=NareenAsad&layout=compact&theme=react&hide_border=true" width="46%" />
</p>
